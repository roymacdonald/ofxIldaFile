...
meta:
	ADDON_NAME = ofxIldaFile
	ADDON_DESCRIPTION = openFrameworks addon for reading and writing ilda (.ild) files 
	ADDON_AUTHOR = @roymacdonald
	ADDON_TAGS = "addon" "ilda" "laser"
	ADDON_URL = http://github.com/roymacdonald/ofxIldaFile
